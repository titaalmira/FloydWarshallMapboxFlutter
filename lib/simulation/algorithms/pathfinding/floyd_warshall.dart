...
import 'package:rute_rumah_sakit_brebes/simulation/algorithms/pathfinding/pathfinding_algorithm_template.dart';

import '../../templateGenerator/graph/node.dart';


class FloydWarshallAlgorithm extends PathFindingAlgorithmTemplate {
  late List<List<int>> nxt;
  late List<List<int>> dist;
  ...
  FloydWarshallAlgorithm(Node root, Node destination, List<Node> nodes, List<Path> paths) : super(root, destination, nodes, paths) {
    ...
    dist = List<List<int>>.generate(V, (i) => List<int>.generate(V, (j) => double.infinity.toInt()));
    preSolve = true;
