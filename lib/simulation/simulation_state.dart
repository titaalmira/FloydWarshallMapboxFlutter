...
import 'package:rute_rumah_sakit_brebes/simulation/simulation_algorithm.dart';

import '../controllers/Controllers.dart';

class Game extends State<GameWrapper> with TickerProviderStateMixin {
  late SimulationAlgorithm simulation;
  ...
  ListView buildListView(BuildContext context) {
	  simulation.locationNode.setState = setState;
  ...
  Row buildAppBar(BuildContext context) {
    return Row(
		...
		children: <Widget>[
			...
			Container(
				child: new Text(
					simulation.locationNode.stateDescription,
					style: TextStyle(color: Colors.black),
				),
			)
		],
